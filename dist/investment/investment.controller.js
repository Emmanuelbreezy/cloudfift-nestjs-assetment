...
let InvestmentController = class InvestmentController {
    ...
    addInvestment(investName, investAmount) {
        const generatedID = this.investmentService.insertInvestment(investName, investAmount);
        return { id: generatedID };
    }
    getInvestment(investId) {
        return this.investmentService.getSingleInvestment(investId);
    }
};
__decorate([
    common_1.Post(),
...
InvestmentController = __decorate([
    common_1.Controller('api/investment'),
